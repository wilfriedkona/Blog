...
<head>
  ...
  <title>Faire un poste sur This Comments</title>
...
<body>
  <header>
    <div class="top-bar">
      ...
      <div class="nav-buttons">
        ...
        <form method="POST" action="{{ route('logout')}}">@csrf<button class="btn" type="submit">Deconnexion</button></form>
  ...
  <main>
    <section class="hero">
      <h1>Faites des Postes sur "This Comments" Commentez librement et sans restrictions </h1>
    </section>
...
<div class="box">
    ...
    <div>
        ...
        <!-- Formulaire -->
        <form action="{{ route('commentaire.store') }}" method="POST" class="form-container">
            @csrf

            <input type="text" name="url" placeholder="https://Entrer l'url du post à commenter">
            <input type="text" name="titre" placeholder="TITRE">
            <textarea name="commentaire" placeholder="Écrire ..."></textarea>
